...
void AModularBuildingGenerator::LoadMeshes()
{
...
void AModularBuildingGenerator::GenerateWallLine(FVector Start, FVector Direction, float Length, FRotator Rotation)
{
    float Position = 0.0f; 
...
void AModularBuildingGenerator::SpawnCornerAt(FVector Location, FRotator Rotation)
{
...
void AModularBuildingGenerator::SpawnRoofCorner(FVector BaseCorner, FRotator Rotation)
{
...
void AModularBuildingGenerator::SpawnRoofLine(FVector StartCorner, FVector EndCorner, FRotator Rotation)
{
...
void AModularBuildingGenerator::SpawnFloorBandLine(FVector Start, FVector Direction, float Length, float ZHeight, FRotator Rotation)
{
    float Position = 0.0f;
