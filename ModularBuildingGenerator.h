...
protected:
    ...
    void GenerateWallLine(FVector Start, FVector Direction, float Length, FRotator Rotation = FRotator::ZeroRotator);
    void SpawnCornerAt(FVector Location, FRotator Rotation);
    void SpawnRoofCorner(FVector BaseCorner, FRotator Rotation);
    void SpawnRoofLine(FVector StartCorner, FVector EndCorner, FRotator Rotation);
    void SpawnFloorBandLine(FVector Start, FVector Direction, float Length, float ZHeight, FRotator Rotation);
